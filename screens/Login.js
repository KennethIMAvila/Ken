  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop: 20}}>
        ...
        <TextInput style={{padding : 10, height: 40, borderColor: '#e5e5e5', borderWidth: 1, borderRadius: 10}} secureTextEntry={this.secureTextEntry} onChangeText={(password) => this.password = password}/>
